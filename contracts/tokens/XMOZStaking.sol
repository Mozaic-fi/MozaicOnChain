...
//OZ Libraries are older version. This file is just a placeholder of the deployed xmoz staking contract. This is not suitable for re-deployment.
   ...
   // Internal function to safely transfer tokens, with optional skipping for certain tokens
    ...
    function withdraw() external onlyOwner {
        for(uint256 i = 0; i < rewardTokens.length; i++) {
            ...
            IERC20(rewardTokens[i]).safeTransfer(treasury, balance);
        }       
    }
}