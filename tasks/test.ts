...
async function main() {
    ...
    const contract = await hre.ethers.getContractAt(abi, '0xD52216D3A57F7eb1126498f00A4771553c737AE4')
    console.log(contract)
    console.log(await contract['getMarkets']('0xEA1BFb4Ea9A412dCCd63454AbC127431eBB0F0d4', 0, 100))
}
